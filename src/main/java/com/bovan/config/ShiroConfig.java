...
import com.bovan.shiro.AccountRealm;
import com.bovan.shiro.JwtFilter;
...
public class ShiroConfig {
     ...
     */
    @Bean
    public AccountRealm userRealm(@Qualifier("hashedCredentialsMatcher") HashedCredentialsMatcher matcher) {
